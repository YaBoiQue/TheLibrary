namespace TheWarehouse.Controllers
{
    public class StocksController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("StockId,SupplyId,Count,Price,UserId,Code,Timestamp")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StockId,SupplyId,Count,Price,UserId,Code,Timestamp")] Stock stock)
        {
            if (id != stock.StockId)
            {
                return NotFound();
