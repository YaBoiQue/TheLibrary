...
{
    public class StockcodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Code,Description,UserId")] Stockcode stockcode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Code,Description,UserId")] Stockcode stockcode)
        {
